...
Carrie Wright is a Research Associate in the Department of [Biostatistics](https://www.jhsph.edu/departments/biostatistics/) at the [Johns Hopkins Bloomberg School of Public Health (JHSPH)](https://www.jhsph.edu/). Dr. Wright is a member of the [Johns Hopkins Data Science Lab (DaSL)](https://jhudatascience.org/) and the [Open Case Studies](https://opencasestudies.github.io/) team.  Dr. Wright's work is focused on innovating ways to make data science and computational biology more accessable to audiences of varied computational experience.
...
You can find Dr. Wright on GitHub at [carriewright11](https://github.com/carriewright11/).
